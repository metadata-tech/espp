function ModalMpgCatatanPemerolehan () {
  
  const className = 'ModalMpgCatatanPemerolehan';
  let self = this;
  let classFrom;
  let id;
  let submitType = '';
  ...
  this.init = function () {
    ...
    $('#btnMmcpClose').on('click', function () {
      console.log('close');
      // $('#modalMpgCatatanPemerolehan').modal('hide');
      // worker.terminate();
    });
  ...
  this.add = function () {
    try {
      ...
      setTimeout(function () {
        ...
        $('#modalMpgCatatanPemerolehan').modal({backdrop: 'static', keyboard: false}).scrollTop(0);
        HideLoader();
      }, 200);
    } catch (e) {
  ...
  this.view = function (_id) {
    try {
      ...
      setTimeout(function () {
        ...
        $('#h5MmcpTitle').html('Maklumat Proses Pemerolehan');
        $('#modalMpgCatatanPemerolehan').modal({backdrop: 'static', keyboard: false}).scrollTop(0);
        HideLoader();
      }, 200);
    } catch (e) {
